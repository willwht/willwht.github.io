...
var CD = ( function() {
	...
	var TELEPORTER_COLOR = PS.COLOR_PURPLE;
	...
	var LEVEL_DATA = [
		...
		{	//index 0, level 0
			...
			pushables : [[3,3],[12,11],[13,11],[14,11],[19,20],[19,18],[20,19],[17,19],[16,19],[21,20],[17,18],[20,21],[18,17],[21,18],[17,20],[18,21],[20,17]]
		},
	];
	...
	var movePlayer = function(x, y){
		...
		if (newData === IS_TELEPORTER){
			//it's a teleporter, teleport player to the other teleporter (max 2) [may not be implemented]
			return;
		}
		...
		if (newData === IS_GOAL){
			if(LEVEL_DATA.length > currentLevel + 1){
				...
				//initializeLevel(-1);
				PS.statusText("End of current prototype - you win!");
				play = false;
				PS.audioPlay( "fx_bloop" );
			}
		}
